...
Early work established the feasibility of measuring migration sentiment using large-scale social media data. In [Rowe et al. (2021)](https://doi.org/10.1017/dap.2021.38), I analysed over 30 million tweets across five countries to examine immigration sentiment during the early stages of the COVID-19 pandemic. A companion IOM paper ([Rowe et al., 2021](https://scholar.google.com/citations?view_op=view_citation&hl=en&user=d8rThGQAAAAJ&cstart=100&pagesize=100&citation_for_view=d8rThGQAAAAJ:3NQIlFlcGxIC)) translated this evidence for migration policy audiences. Together, these studies demonstrated that migration-related discourse responds to epidemiological shocks and political developments and that sentiment content varies across national contexts. This provided empirical evidence that digital trace data can detect rapid attitudinal shifts that conventional surveys cannot capture in real time.
...
Rowe, F., Mahony, M., Sievers, N., Rango, M., & Graells-Garrido, E. (2021). *Sentiment towards Migration during COVID-19: What Twitter Data Can Tell Us*. International Organization for Migration. [Google Scholar record](https://scholar.google.com/citations?view_op=view_citation&hl=en&user=d8rThGQAAAAJ&cstart=100&pagesize=100&citation_for_view=d8rThGQAAAAJ:3NQIlFlcGxIC)

Mason, M., & Rowe, F. (2025). Tweeting migration: A decade of shifting sentiment across local areas of Great Britain. *SocArXiv*. [https://doi.org/10.31235/osf.io/x25ch_v1](https://doi.org/10.31235/osf.io/x25ch_v1)
...
Nasuto, A., Iacus, S., Rowe, F., & Jain, S. (2025). Learning the topic, not the language: How LLMs classify online immigration discourse across languages. *arXiv (Cornell University)*. [https://doi.org/10.48550/arXiv.2508.06435](https://doi.org/10.48550/arXiv.2508.06435)
...
Rowe, F., Mahony, M., Graells-Garrido, E., Rango, M., & Sievers, N. (2023). Using Twitter data to monitor immigration sentiment. In *Harnessing Data Innovation for Migration Policy: A Handbook for Practitioners* (pp. 104-119). International Organization for Migration. [https://livrepository.liverpool.ac.uk/3135232/](https://livrepository.liverpool.ac.uk/3135232/)
